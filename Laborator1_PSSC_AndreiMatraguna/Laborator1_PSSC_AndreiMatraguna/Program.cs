using Laborator1_PSSC_AndreiMatraguna.Domain;
using System;
using System.Collections.Generic;
using static Laborator1_PSSC_AndreiMatraguna.Domain.ShoppingCarts;

namespace Laborator1_PSSC_AndreiMatraguna
{
    class Program
    {
